...
public class Contact_Us extends AppCompatActivity implements NetworkUtilsReceiver.NetworkResponseInt {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_hot:
                Intent intent1 = new Intent(Contact_Us.this,Checkout_Submit.class);
